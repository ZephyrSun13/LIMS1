...
Tab <- Tab[Tab$Group %in% c("Other", "NEJRisk"), ]

Tab$Group <- factor(Tab$Group, levels = c("Other", "NEJRisk"))
...
write.table(Stat, file = paste0(Args[1], "_Stat_condition.NEJ.xls"), sep = "\t", quote = F, col.names = NA)
