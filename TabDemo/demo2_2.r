...
Tab <- Tab[Tab$Group %in% c("Other", "Maj", "Min"), ]

Tab$Group <- factor(Tab$Group, levels = c("Other", "Maj", "Min"))
...
write.table(Stat, file = paste0(Args[1], "_Stat_condition.Haplo.xls"), sep = "\t", quote = F, col.names = NA)
