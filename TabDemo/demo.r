...
Tab$Group[Tab$GenoGroup2 == "Maj1" & Tab$NEJGenoGroup != "Risk"] <- "Maj1"

Tab$Group[Tab$GenoGroup2 == "Maj2" & Tab$NEJGenoGroup != "Risk"] <- "Maj2"

Tab$Group[Tab$GenoGroup2 == "Min1" & Tab$NEJGenoGroup != "Risk"] <- "Min1"

Tab$Group[Tab$GenoGroup2 == "Min2" & Tab$NEJGenoGroup != "Risk"] <- "Min2"

Tab$Group[Tab$NEJGenoGroup == "Risk"] <- "NEJRisk"

Tab$Group <- factor(Tab$Group, levels = c("Other", "NEJRisk", "Maj1", "Maj2", "Min1", "Min2"))
...
write.table(Stat, file = paste0(Args[1], "_Stat_condition.xls"), sep = "\t", quote = F, col.names = NA)
